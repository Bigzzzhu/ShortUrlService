...
//					envCtx.lookup("jdbc/MyDataSource");
			ds = new ComboPooledDataSource("shortURL");
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static Connection getConnection() {
		...
		try {
			connection = threadLocal.get();
			String dbPame = ConfigureUtils.getProperty("dbname");
			String dbPassword = ConfigureUtils.getProperty("dbpassword");

			if (connection == null) {
				connection = ds.getConnection(dbPame, dbPassword);
